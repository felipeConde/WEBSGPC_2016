...
Partial Class GastoUsuarioRamal
    ...
    Public MostraCreditoRamal As Boolean = True
    ...
    Sub ExibeCreditoRamal()
        Dim myItems As List(Of AppGeneric) = _dao_commons.GetGenericList("OCULTA_CREDITORAMAL_GESTAO", "NOME_PARAMETRO", "VALOR_PARAMETRO", "PARAMETROS_SGPC")
        If myItems.Count > 0 Then
            Dim _code As String = myItems.Item(0).Descricao.ToString

            If _code.ToUpper = "S" Then
                'ESCONDE O CREDITO
                MostraCreditoRamal = False
            Else
                MostraCreditoRamal = True
