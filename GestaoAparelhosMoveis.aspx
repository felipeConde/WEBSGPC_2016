<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GestaoAparelhosMoveis.aspx.vb" MasterPageFile="~/Site.master" 
    Inherits="GestaoAparelhosMoveis" %>
<%@ Reference Control="~/Site.master" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <head>

        <title>Aparelhos Móveis</title>
    ...
    <script type="text/javascript">
        ...
        function CarregaGrid() {
            ...
            $("#list1").bootgrid({
                ...
                ajax: true,
                url: '<%=myUrl%>GestaoAparelhosMoveis.aspx?operacao=1',
        ...
        function abreJanela(id) {
            ...
            if (id == "0" || id == "") {
                arquivo = "AparelhosMoveisDetalhes.aspx"
            }
            else {
                //id = id.replace('?id=', '');
                arquivo = "AparelhosMoveisDetalhes.aspx?codigo=" + id
            }
        ...
        <div class="card" id="card_grid">
            ...
            <div class="table-responsive">
                ...
                <table id="list1" class="table table-condensed table-hover table-striped">
                    <thead>
                        <tr>
                            <th data-column-id="ID" data-type="string" data-visible="false" data-identifier="true" >CODIGO</th>
                            <th data-column-id="NUM_LINHA">NÚMERO</th>
                            <th data-column-id="MARCA">MARCA</th>
                            <th data-column-id="MODELO">MODELO</th>
                            <th data-column-id="NOME_USUARIO">NOME USUÁRIO</th>
                            <th data-column-id="MATRICULA">MATRÍCULA</th>
                            <th data-column-id="CODIGO_GRUPO">AR</th>
                            <%--<th data-column-id="GRUPO">GRUPO</th>--%>
                            <%--<th data-column-id="CLASSIFICACAO">CLASSIFICAÇÃO</th>--%>
                            <th data-column-id="STATUS">STATUS</th>
                            <th data-column-id="FORNECEDOR">FORN.</th>
                            <th data-column-id="IMEI">IMEI</th>
                            <%--<th data-column-id="SIMCARD">SIMCARD</th>--%>
                            <%--<th data-column-id="TERMO">TERMO</th>--%>
                            <%--<th data-column-id="SERIAL_NUMBER">SERIAL</th>--%>
                            <%--<th data-column-id="FLEET" >FLEET</th>--%>
                            <%--<th data-column-id="ESTOQUE">ESTOQUE</th>--%>
