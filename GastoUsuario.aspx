...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div id="myApp" ng-app="SGPCAPP" ng-controller="usuarioCtrl">
        ...
        <ul class="tab-nav" role="tablist" data-tab-color="teal">
                                        ...
                                        <li id="exibe_tarifacao" runat="server"><a href='GastoUsuarioRamal.aspx?mostraArea=<%= ViewState("mostraArea")  %>'>Ramais</a></li>                                        
                                    </ul>
                ...
                <div class="card-body card-padding">
                    <div class="row">
                        <div class="col-sm-9 m-b-15">
                            <h2>Funcionários</h2>
                            <select ng-model="ddlFuncionarios" ng-options="x as x.Descricao for x in listUsuarios track by x.Valor" data-placeholder="Selecione" id="cmbUsuarios" style="width: 100%" ng-change="buscaUsuarios(this)" ng-model='<%=Session("codigousuario") %>'>
                                                                
                            </select>
                            
                            <md-autocomplete md-no-cache="true" md-selected-item="selectedItem" md-items="item in listUsuarios" md-search-text="searchText" md-item-text="item.Descricao">
                       ...
                       <table class="table table-striped">
                           ...
                           <tbody>
                               <tr ng-repeat="x in resumo">
                                   ...
                                   <td>{{x.PARCELAMENTO | currency }} {{x.PARCELAS}}</td>
                     ...
                     <div class="col-sm-6 col-md-4">
                                <div class="mini-charts-item bgm-bluegray">
                                    <div class="clearfix">
                                        <div class="chart stats-bar"></div>
                                        <div class="count">
                                            <small>Variação em ralação a média da Área </small>
   ...
   <%--  <script src="vendors/bower_components/angular-chosen-localytics/chosen.js" async=""></script>--%>
    ...
    <script>
        ...
        $("#menu-trigger").click(function () {
            ...
            //$("#tw-switch").trigger("click");
            //$("#menu-trigger").addClass("open");
            //$("#menu-trigger").trigger("#sidebar");
            //$("#menu-trigger").removeAttr("class");
            
            //$("#sidebar").addClass("sidebar c-overflow mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar toggled");
            
            if ($("#sidebar").hasClass("sidebar c-overflow mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar toggled"))
            {
                $("#sidebar").removeAttr("class");
                $("#sidebar").addClass("sidebar c-overflow mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar");
                $("#menu-trigger").removeAttr("class");
            }
            else
            {
