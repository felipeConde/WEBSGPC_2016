...
Public Class DAORamais
    ...
    Public Function GetRamaisById(ByVal pnumero_a As String, ByRef listRamal As List(Of AppRamais)) As Boolean
        ...
        Try
            ...
            strSQL = strSQL + ",r.EM_USO,r.CREDITO_EM_USO,r.BLOQUEIO_EMAIL,nvl(r.CUSTO_RAMAL,0)CUSTO_RAMAL,r.IDSUBGRUPO,r.CATEGORIA"
            ...
            strSQL = strSQL + ",gr.NOME_GRUPO,us.NOME_USUARIO,us.CIDADE as UNIDADE,us.CARGO_USUARIO as SETOR,nvl(r.CUSTO_SERVICO,0)CUSTO_SERVICO,r.obs "
            strSQL = strSQL + " from RAMAIS r, GRUPOS gr ,USUARIOS us "
            ...
            strSQL = strSQL + " where r.GRP_CODIGO = gr.CODIGO(+) and r.codigo_usuario=us.codigo(+) and r.NUMERO_A = '" + pnumero_a + "'"
            ...
            Using connection
                While reader.Read
                    ...
                    _registro.CUSTO_SERVICO = reader.Item("CUSTO_SERVICO").ToString
