<%@ Page Language="VB" AutoEventWireup="false" CodeFile="uc_graficoUsuarioMedia.aspx.vb" Inherits="uc_graficoUsuarioMedia" %>
...
<body>
    ...
    <script>
         ...
         $(function () {
             //alert('teste');
             $('#containerMedia').width($('#myApp').width()-50);
